...
/app/bin/cx scan create --project-name "${PROJECT_NAME}" -s "." --branch "${BRANCH#refs/heads/}" --scan-info-format json --agent "Github Action" --sca-filter '!**/**,packages/**,**/manifests/**,**/plugins/**' | tee -i $output_file
